...
public class formRegisOrden extends javax.swing.JFrame {
	...
	*/
		...
		try {
			...
			this.setTitle("MC'Dongo/Registrar Orden");
			{
				...
				}
				{
					...
					pnDatos.setBounds(32, 22, 630, 309);
					{
					...
					}
					{
						...
						lblNumero.setText(" 00001");
						lblNumero.setFont(new java.awt.Font("Purisa",1,11));
						lblNumero.setBounds(554, 18, 52, 15);
					}
					{
						pnPedido = new JPanel();
...

						{
							...
							btAgregar.setBounds(441, 88, 107, 25);
						...
						}
						{
							...
							btRetirar.setBounds(441, 118, 107, 27);
							btRetirar.setText("Remover");
							btRetirar.setFont(new java.awt.Font("Purisa",1,11));
						}
						{
					}
					{
					...
					}
					{
						...
						pnDatos.add(lblN);
						lblN.setText("N°");
						lblN.setBounds(535, 16, 37, 15);
						lblN.setFont(new java.awt.Font("Purisa",1,11));
					}
				}	
			}
		}
	...
	public void AgregarEscuchadores(ActionListener actionlistener){
		...
		this.cmbCategoria.addActionListener(actionlistener);
		this.cmbProducto.addActionListener(actionlistener);
		this.btRetirar.addActionListener(actionlistener);
	}
